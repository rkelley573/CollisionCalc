    ...
    fun allFormulas(): List<Formula> {
        ...
        list += Formula(
            ...
            Computed(
                title = "Velocity: ${fmt(V)} ft/s",
                equationText = "V = d / T",
                inputs = listOf(CalcValue("d", dIn, ctx.distanceUnit.label), CalcValue("T", tIn, ctx.timeUnit.label)),
        ...
        list += Formula(
            ...
            Computed(
                title = "μ: ${fmt(mu, 6)}",
                equationText = "μ = S² / (30·d)",
                inputs = listOf(CalcValue("S", S, "mph"), CalcValue("d", dIn, ctx.distanceUnit.label)),
                outputs = listOf(CalcValue("μ", mu, "drag")),
                steps = listOf(
                    "d(ft) = ${fmt(dIn)} → ${fmt(dFt)} ft",
        ...
        list += Formula(
            ...
            Computed(
                title = "μ: ${fmt(mu, 6)}",
                equationText = "μ = (VF − V0) / (32.2·T)",
                inputs = listOf(CalcValue("V0", v0, "ft/s"), CalcValue("VF", vf, "ft/s"), CalcValue("T", tIn, ctx.timeUnit.label)),
                outputs = listOf(CalcValue("μ", mu, "drag")),
                steps = listOf(
                    "T(sec) = ${fmt(tIn)} → ${fmt(tSec)} sec",
        ...
        list += Formula(
            ...
            Computed(
                title = "μ: ${fmt(mu, 6)}",
                equationText = "μ = (VF² − V0²) / (64.4·d)",
                inputs = listOf(CalcValue("V0", v0, "ft/s"), CalcValue("VF", vf, "ft/s"), CalcValue("d", dIn, ctx.distanceUnit.label)),
                outputs = listOf(CalcValue("μ", mu, "drag")),
                steps = listOf(
                    "d(ft) = ${fmt(dIn)} → ${fmt(dFt)} ft",
        ...
        list += Formula(
            ...
            Computed(
                ...
                equationText = "T = d / V",
                inputs = listOf(CalcValue("d", dIn, ctx.distanceUnit.label), CalcValue("V", V, "ft/s")),
        ...
        list += Formula(
            ...
            Computed(
                title = "Time: ${fmt(tOut)} ${ctx.timeUnit.label}",
                equationText = "T = (V0 − VF) / a",
                inputs = listOf(CalcValue("V0", v0, "ft/s"), CalcValue("VF", vf, "ft/s"), CalcValue("a", a, "ft/s²")),
                outputs = listOf(CalcValue("T", tOut, ctx.timeUnit.label)),
                steps = listOf(
        ...
        list += Formula(
            ...
            Computed(
                title = "Time: ${fmt(tOut)} ${ctx.timeUnit.label}",
                equationText = "T = 0.25 · √(d / μ)",
                inputs = listOf(CalcValue("d", dIn, ctx.distanceUnit.label), CalcValue("μ", mu, "drag")),
                outputs = listOf(CalcValue("T", tOut, ctx.timeUnit.label)),
                steps = listOf(
                    "d(ft) = ${fmt(dIn)} → ${fmt(dFt)} ft",
        ...
        list += Formula(
            ...
            Computed(
                title = "Distance: ${fmt(dOut)} ${ctx.distanceUnit.label}",
                equationText = "d = V0·t ± (a·t²)/2",
                inputs = listOf(CalcValue("V0", v0, "ft/s"), CalcValue("a", a, "ft/s²"), CalcValue("t", tIn, ctx.timeUnit.label)),
                outputs = listOf(CalcValue("d", dOut, ctx.distanceUnit.label)),
                steps = listOf(
                    "t(sec) = ${fmt(tIn)} → ${fmt(tSec)} sec",
        ...
        list += Formula(
            ...
            Computed(
                title = "θ: ${fmt(theta)}°",
                equationText = "θ = atan(h/d)",
                inputs = listOf(CalcValue("d", dIn, ctx.distanceUnit.label), CalcValue("h", hIn, ctx.distanceUnit.label)),
